User.create!([
  {email: "tyler@gmail.com", encrypted_password: "$2a$12$Hkjbgbjzh6kMe3/0444LOOeZav66xUH6shhwxjRmS2y8pgEwTGSWG", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, name: "Tyler Durden", status: nil},
  {email: "marla@gmail.com", encrypted_password: "$2a$12$gIBeeXu6Hy3lVSLuncFMNur.0oeyXG/s93QyRjaBZnO7o40UF4o1.", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, name: "Marla Singer", status: nil},
  {email: "mkrtichsargsyan24@gmail.com", encrypted_password: "$2a$12$JhCfOWzOQ/3iBoniKIn14uHZ5/5jlC52S0GmiGaCRPQM2aH3K0mTe", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, name: "Mike Sargsyan", status: nil}
])
Post.create!([
  {user_id: 27, title: "Delete your social media", description: "Quitting social media is the most finely targeted way to resist the insanity of our times."},
  {user_id: 27, title: "Vandalizing", description: "Go and destroy a piece of corporate art"},
  {user_id: 28, title: "Fight with stranger", description: "Get into a fight , lose, then show up to work or school with those bruises and act like nothing happened."},
  {user_id: 31, title: "Barcelona jersey", description: "Wear a Barcelona jersey in Madrid"}
])
...
ActiveStorage::Attachment.create!([
  {name: "avatar", record_type: "User", record_id: 14, blob_id: 1},
  {name: "avatar", record_type: "User", record_id: 27, blob_id: 6},
  {name: "avatar", record_type: "User", record_id: 28, blob_id: 7},
  {name: "avatar", record_type: "User", record_id: 31, blob_id: 10}
])
